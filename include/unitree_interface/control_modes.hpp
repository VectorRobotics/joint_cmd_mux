...
namespace unitree_interface {
    ...
    struct ControlModeTraits<std::monostate> {
        static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_MONOSTATE;
    ...
    struct ControlModeTraits<IdleMode> {
        static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_IDLE;
    ...
    struct ControlModeTraits<HighLevelMode> {
        static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_HIGH_LEVEL;
    ...
    //     static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_HYBRID;
    ...
    struct ControlModeTraits<LowLevelMode> {
        static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_LOW_LEVEL;
    ...
    struct ControlModeTraits<EmergencyMode> {
        static constexpr std::uint8_t id = msg::ControlMode::CONTROL_MODE_EMERGENCY;
